...
// 현재글의 Download 수를 올림;;
if($filenum==1) {
	mysqli_query($connect,"update `$t_board"."_$id` set download1=download1+1 where no='$no'");
} else {
	mysqli_query($connect,"update `$t_board"."_$id` set download2=download2+1 where no='$no'");
}
