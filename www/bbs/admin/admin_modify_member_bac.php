...
?>
    <input type=input name=maxdirsize value="<?=$maxDirSize?>" size=10 maxlength=20 class=input> KByte &nbsp; 이미지 창고의 사용 용량을 지정해 줄수 있습니다.
  </td>
</tr>
<tr height=22 align=center>
...
?>
    ...
    * 정해진 회원의 이름 앞에만 나타나는 아이콘입니다. <br>
    <font color=#e0e0e0>* </font>(GIF 파일만 가능합니다. 16x16 px 이하로 해주세요)
  </td>
</tr>
...
<?
    ...
    * 정해진 회원의 이름을 대신해서 나타나는 아이콘입니다. <br>
    ...
    <font color=#e0e0e0>* </font>(GIF 파일만 가능합니다. 크기는 60x16 px 이하로 해주세요)
  </td>
</tr>
<tr height=22 align=center>
