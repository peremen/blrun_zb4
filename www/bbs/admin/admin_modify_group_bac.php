...
<tr align=right bgcolor=#e0e0e0><td style=font-family:Tahoma;font-size:8pt;> <font color=red>*</font> <b>그룹이름</b>&nbsp;&nbsp;</td><td align=left>&nbsp;<input value="<?=$data[name]?>" type=text name=name size=20 maxlength=20 class=input style=border-color:#b0b0b0> 그룹이름을 입력하세요</td>
</tr>
...
<!-- 헤더, 푸터  -->
<tr height=25 bgcolor=bbbbbb><td colspan=2  align=center  style=font-family:Tahoma;font-size:8pt;><b>게시판 상하단에 출력한 파일, 내용 지정</td>
</tr>
