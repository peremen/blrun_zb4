...
<tr align=right bgcolor=#e0e0e0><td style=font-family:Tahoma;font-size:9pt;> <font color=red>*</font> <b>그룹이름</b>&nbsp;&nbsp;</td><td align=left>&nbsp;<input value="<?=$data[name]?>" type=text name=name size=20 maxlength=20 class=input style=border-color:#b0b0b0> 그룹이름을 입력하세요</td>
</tr>
<tr align=right bgcolor=#e0e0e0><td style=font-family:Tahoma;font-size:9pt;> <b>그룹 공개</b>&nbsp;&nbsp;</td><td align=left><table border=0 cellpadding=0 cellspacing=0><tr><td><input type=radio name=is_open <?=$check_open[1]?> checked value=1></td><td style=font-family:Tahoma;font-size:9pt;> Yes &nbsp;&nbsp;</td><td><input type=radio name=is_open <?=$check_open[0]?> value=0></td><td style=font-family:Tahoma;font-size:9pt;> No &nbsp; 공개그룹이면 Yes, 아니면 No를 선택하요</td></tr></table></td>
</tr>
<tr align=right bgcolor=#e0e0e0><td style=font-family:Tahoma;font-size:9pt;><b>회원 가입 허용</b>&nbsp;&nbsp;</td><td align=left><table border=0 cellpadding=0 cellspacing=0><tr><td><input type=radio name=use_join <?=$check_join[1]?> value=1></td><td style=font-family:Tahoma;font-size:9pt;> Yes &nbsp;&nbsp;</td><td><input type=radio name=use_join <?=$check_join[0]?> value=0></td><td style=font-family:Tahoma;font-size:9pt;> No &nbsp; 회원가입을 허용할거면 Yes, 아니면 No를 선택하세요</td></tr></table></td>
</tr>
<tr align=right bgcolor=#e0e0e0><td style=font-family:Tahoma;font-size:9pt; valign=top><img src=images/t.gif height=3><br><b>그룹 아이콘</b>&nbsp;&nbsp;</td><td align=left style=font-family:Tahoma;font-size:9pt;line-height:160%>&nbsp;<input type=file name=icon size=40 class=input style=border-color:#b0b0b0;font-family:Tahoma;font-size:9pt;><br>&nbsp; 일반멤버들의 아이콘을 지정하세요.<br>&nbsp;(Under Width,Height 24pixel JPG/JEPG/GIF/PNG/BMP File format)
<br><?if($data[icon]) echo "&nbsp;<b>현재 아이콘이 저장되어 있습니다 (<img src=icon/$data[icon] border=0> <input type=checkbox name=del_icon value=1> 삭제)";?></td>
</tr>
<tr align=right bgcolor=#e0e0e0><td style=font-family:Tahoma;font-size:9pt;><b>회원 표시 방법</b>&nbsp;&nbsp;</td><td align=left><table border=0 cellpadding=0 cellspacing=0><tr><td><input type=radio name=use_icon value=0 <?=$check_use_icon[0]?>></td><td style=font-family:Tahoma;font-size:9pt;> Icon &nbsp&nbsp;</td><td><input type=radio name=use_icon value=1 <?=$check_use_icon[1]?>></td><td style=font-family:Tahoma;font-size:9pt;> Bold Text &nbsp;&nbsp;</td><td><input type=radio name=use_icon value=2 <?=$check_use_icon[2]?>></td><td style=font-family:Tahoma;font-size:9pt;> None division viewing</td></tr><tr><Td colspan=4 height=20>&nbsp;회원표시 방법을 선택하세요</td></tr></table></td>
</tr>
