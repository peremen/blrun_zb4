...
?>
	<b><?=$id?></b> 게시판</b>
	 ...
	 - 총 업로드 갯수 : <?=number_format($filesnum1+$filesnum2+$filesnum3+$filesnum4)?> 개
...
?>
	...
	<b>전체 경로가 잘못된 첨부파일 필드수 :</b> <?=number_format($ntotalfilesnum)?>

	<b>경로가 잘못된 첨부파일 필드, 파일 존재 갯수 :</b> <?=number_format($existsfilesnum)?>
