...
<tr>
	<td style="width:100%;">
		<div style="float:left;display:inline;">
			<a href="http://twitter.com/share" class="twitter-share-button" data-text="<?=strip_tags(str_replace("\"","&quot;",$subject))?>" data-url="<?=urldecode($social_ref)?>" data-count="horizontal" data-via="<?=preg_replace("#http[s]?\:\/\/#i","",str_replace("www.","",substr(zbUrl(),0,strpos(zbUrl(),"/bbs/"))))?>">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
		</div>
