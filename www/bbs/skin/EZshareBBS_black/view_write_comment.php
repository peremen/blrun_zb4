<tr>
<!--가로점선 -->
	<td colspan=2 height=1 background=<?=$dir?>/dot_line.gif></td></tr>
</table>
<?
$pass = $_POST["pwd"];
...
<!--코멘트 이름, 비번, 내용 시작-->
	...
	<tr align=center valign=top>
	  <td nowrap height=80>
	     ...
	     <font style=font-family:Verdana;font-size:9pt;letter-spacing:-1px;><b>패스워드</b></font><br>
	  ...
	  <td>
	    ...
	    <tr><td width=100% valign=top>
	      <textarea id=memo name=memo <?=size(40)?> rows=8 class=zv3_textarea style=width:100% onkeydown='return doTab(event);'></textarea>
		</td></tr>
		</table>
	  </td>
	  <td><input type=submit rows=5 <?if($browser){?>class=zv3_submit<?}?> value='작성완료' accesskey="s"></td>
	</tr>
	</table>
