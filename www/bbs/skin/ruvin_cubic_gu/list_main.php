...
<tr>
<td class=cu><?=$hide_cart_start?><input type=checkbox name=cart value="<?=$data[no]?>"><?=$hide_cart_end?>&nbsp;<span class=notice>*&nbsp;</span><span class=v7><b>N</b>o. <?=$number?></span>&nbsp;&nbsp;<?=$name?></td>
