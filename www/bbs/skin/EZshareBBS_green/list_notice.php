...
<!--회원아이콘, 작성자--><? if($browser=="1"){ ?><td nowrap='nowrap'><div style="overflow:hidden"><?=$face_image?>&nbsp;<?=$name?>&nbsp;</div></td><? } ?>
<!--작성일--><? if($browser=="1"){ ?><td nowrap='nowrap' class=zv3_small><?=$reg_date?></td><? } ?>
<? if($browser=="1"){ ?>
<!--조회--><td nowrap='nowrap' class=zv3_small><?=$hit?></td>
<!--추천--><td nowrap='nowrap' class=zv3_small><?=$vote?></td>
<? } ?>
</tr>
