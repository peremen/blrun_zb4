...
<tr>
	...
	<td align=left><input type=text id=name name=name value="<?=$name?>" <?=size(20)?> maxlength=20 onkeyup="ajaxLoad2()" title="이름과 비번을 재입력하면 임시저장이 복원됨"></td>
</tr>
<tr>
	<td align=right><font class=list_eng><b>Password</b></font></td>
	<td align=left><input type=password id=password name=password <?=size(20)?> maxlength=20 onkeyup="ajaxLoad2()" title="이름과 비번을 재입력하면 임시저장이 복원됨"></td>
</tr>
<tr>
