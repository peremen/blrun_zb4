...
<tr valign=top>
	<td style='word-break:break-all;padding-left:10px;' class=list_han>
		...
		<tr>
			<td align=left width=><?=$c_face_image?> <?=$comment_name?> </b><font class=list_eng color=888888>(<?=date("Y-m-d H:i:s",$c_data[reg_date])?>) <?=$show_comment_ip?></font> <?=$a_comm_r?><img src=<?=$dir?>/reply.gif border=0 align=absmiddle></a></td>
...
<tr>
	<td align=left class=memo style='padding:2px;padding-left:10px;padding-top:5px;'>&nbsp;:::
		<?
...
<tr>
	<td align=right class=list_han><?=$c_bitly?>[bitly]</a></td>
</tr>
<tr>
