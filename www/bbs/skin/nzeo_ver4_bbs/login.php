...
<tr>
	...
	<td class=list1 align=left><input type=text name=user_id size=20 maxlength=20 class=input style=width:80%> <input type=checkbox name=SSL_Login value=1 checked onclick=check_SSL_Login() title="보안접속 설정/해제"></td>
</tr>
<tr>
	<td class=list0 align=right height=26><font class=list_eng>Password</font></td>
	<td class=list1 align=left><input type=password name=password size=20 maxlength=20 class=input style=width:80%></td>
</tr>
</table>
<br>
