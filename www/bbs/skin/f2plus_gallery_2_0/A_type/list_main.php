...
?>
	...
	<tr align=center height=45 style=padding-bottom:0px class=list<?=$coloring%2?>>
		<?if($hide_no=="off"){?><? if($browser=="1"){ ?><td style=padding-top:0px;padding-bottom:4px class=list_eng align=center nowrap><div style="overflow:hidden"><?=$number?></div></td><? } ?><?}?>
		...
		<td>
			...
			<tr valign=middle>
				<td align=left><div style="overflow:hidden"><nobr><font style=color:B0B0B0><? if(!$data[is_secret]) echo substr(stripslashes($_name1[0]),0,400); else echo "비밀글입니다"; ?></font></nobr></div></td>
