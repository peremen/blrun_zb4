...
?>
	...
	<tr align=center height=45 style=padding-bottom:0px class=list<?=$coloring%2?>>
		...
		<td>
			...
			<tr valign=middle>
				<td align=left><div style="overflow:hidden"><nobr><font style=color:#B0B0B0><? if(!$data[is_secret]) echo del_html(mb_substr($_name1[0],0,300)); else echo "비밀글입니다"; ?></font></nobr></div></td>
