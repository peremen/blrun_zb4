...
$t_c=mysqli_fetch_array(mysqli_query($connect,"select * from $table where reg_date='$c_data[reg_date]'"));
...
<tr><td>
	...
	<tr>
		...
		<br><font class=list_han><?if($c_data[is_secret]) echo "<img src=".$dir."/post_security.gif border=0>";?><?if(preg_match("#\|\|\|[0-9]{1,}\|[0-9]{1,10}$#",$o_data[memo])) echo "<font color=blue>To $o_data[name]</font>";?>
