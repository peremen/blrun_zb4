...
$m_memo = explode("|||",htmlspecialchars(str_replace("&amp;","&",str_replace("&lt;","<",$memo)),ENT_COMPAT,'ISO-8859-1',true));
$_name1 = $m_memo[0];
$_name2 = $m_memo[1];
$_name3 = $m_memo[2];
$_name4 = $m_memo[3];
...
<tr>
  <td align=right><font class=com2>감독</font></td>
...
<tr>
  <td align=right><font class=com2>개봉일</font></td>
...
<tr>
  <td align=right><font class=com2>상영시간</font></td>
  <td align=left><input type=text id=_name8 name=_name8 value="<?=$_name8?>" <?=size(10)?> maxlength=200 class=input>분</td>
</tr>
<tr>
  <td background=<?=$dir?>/dot.gif height=1 colspan=2></td>
</tr>
<tr>
  <td align=right><font class=com2>장르</font></td>
...
<tr>
  <td align=right><font class=com2>주연</font></td>
...
<tr>
  <td align=right><font class=com2>예고편 URL</font></td>
...
<tr valign=top>
  <td align=right><font class=com2><b>영화제목</b></font></td>
...
<tr>
  <td align=right onclick=document.getElementById('memo').rows=document.getElementById('memo').rows+4 style=cursor:pointer>
  <font class=com2><b>내용</b></font> <font class=com2>▼</font></td>
  <td align=left style=padding-top:8px;padding-bottom:8px;><textarea id=memo name=memo <?=size2(90)?> rows=12 class=textarea style=width:99% onkeydown='return doTab(event);' onkeyup="addStroke()"><?=$_name1?></textarea></td>
</tr>
<tr>
  <td background=<?=$dir?>/dot.gif height=1 colspan=2></td>
</tr>
...
<tr>
  <td align=right><font class=com2>공식 홈페이지</font></td>
...
<tr>
  <td align=right><font class=com2>업로드 #1</font></td>
...
<tr>
  <td align=right><font class=com2>업로드 #2</font></td>
