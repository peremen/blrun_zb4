...
<tr class=list2 valign=top>
	<td valign=top>
		...
		<? if (!$view_img2){
			echo "</td></tr><tr><td><table width=100% border=0 cellspacing=0 cellpadding=0><tr><td height=4></td></tr><tr><td height=1 background=$dir/dot.gif></td></tr><tr><td height=4></td></tr></table><B>&nbsp;영화내용</B>(줄거리) :<BR><BR>".$_name1."<BR><BR>";
