...
<td valign=top>
	...
	<tr valign=top>
		<td style=padding-left:10px><?=$print_img1?><?=$view_img1?></a>
			...
			<tr><td nowrap width=50><img src=<?=$dir?>/bolddot.gif border=0 align=absmiddle><B>&nbsp;제목</B> :&nbsp;</td><td nowrap width=100%><?=$subject?></td>
			</tr>
			</table>
			...
			<tr bgcolor=eeeeee height=15>
				<td align=right colspan=2>
					...
					<tr><td align=right>
						<a href=<?=$data[sitelink2]?> target=_blank><font class=list_eng><img src=<?=$dir?>/bolddot.gif border=0 align=absmiddle>&nbsp;관련홈페이지</font></a> <a href="#m_review_w"><font class=list_eng><img src=<?=$dir?>/m_review_w.gif border=0 align=absmiddle>영화평쓰기</font></a>
						</td>
