...
<td>
	...
	<tr valign=center>
    <td><a href=<?=urlencode("매뉴얼.txt")?> target=_blank><U>※ " 설정하시기 전에 이곳을 클릭해 꼭 메뉴얼을 참조하세요."</U></a>
	</td>
    </td>
    </table>
...
if($exif==1){
	if(file_exists("exiflist")){
		if(!@chmod("exiflist",0505)){
			echo "<br>exiflist 파일의 퍼미션 조정에 실패 했습니다.<br>exiflist 파일의 퍼미션을 <font color=FF2400><B>505</B></font> 로 수정하세요<br>반드시 퍼미션을 조정하셔야 합니다. 이파일의 경우는 수동으로 설정 퍼미션을 설정하셔야 합니다.<br>";
