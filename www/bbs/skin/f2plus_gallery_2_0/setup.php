...
<tr>
  ...
  <td align=right>
    ...
    <?=$a_logout?>Logout</a>
    <?=$a_setup?>Admin</a>
    <?if($member[is_admin]==1){?><INPUT TYPE="hidden" name=id value=<?=$id?>><INPUT TYPE="hidden" name=zb_path value=<?=$config_dir?>><INPUT TYPE="hidden" name=user_id value=<?=$member[user_id]?>><INPUT TYPE="hidden" name=password value=<?=$member[password]?>><INPUT TYPE=image src=<?=$dir?>/sc.gif align=absmiddle border=0><?}?><font size=3>&nbsp;</font>
  </td>
</tr>
</FORM>
</table>
