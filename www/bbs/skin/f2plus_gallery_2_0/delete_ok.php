...
if(!preg_match("#".$HTTP_HOST."#i",$HTTP_REFERER)) Error1("정상적으로 글을 삭제하여 주시기 바랍니다.");
if(getenv("REQUEST_METHOD") == 'GET' ) Error1("정상적으로 글을 삭제하시기 바랍니다","");

// 게시판 이름 지정이 안되어 있으면 경고;;;
if(!$id) Error1("게시판 이름을 지정해 주셔야 합니다.<br><br>예) zboard.php?id=이름","");
...
// 설정되지 않은 게시판일때 에러 표시
if(!$setup[name]) Error1("생성되지 않은 게시판입니다.<br><br>게시판을 생성후 사용하십시요","");
...
if($group[is_open]==0&&!$is_admin&&$member[group_no]!=$setup[group_no]) Error1("공개 되어 있지 않습니다");
