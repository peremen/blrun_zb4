	...
	<td>
		...
		<tr valign=top>
			<td>
				...
				<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
				<tr valign=top><td class=han2>3. 이모티콘 사용 </td><?if($emoticon_use=="off") $select=""; else $select="checked";?><td><input type="checkbox"  value=1 name=emouse <?=$select?>></td></tr>
				<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
				...
				<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
				<tr valign=top><td class=han2>5. 최대 썸네일 가로크기 </td><td><input type="text" class=textarea name=maxwidth size=5 value=<?=$max_width_size?>></td></tr>
				<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
				</table>
			</td>
			<td valign=middle>
			...
			<td align=left>
				...
				<td class=han2><input type="text" class=textarea name=zburl size=38 value=<?=$zb_url?>>	끝에 "/" 넣지마세요</td>
				</tr>
				<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
				...
				<td class=han2><input type="text" class=textarea name=emoticon_url size=38 value=<?=$emoticon_url?>>	끝에 "/" 넣지마세요</td>
				</tr>
				<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
...
?>
				<tr><td colspan=2 align=left class=han3>◎ GD Version 선택&nbsp;&nbsp;<INPUT TYPE="radio" NAME="gd_use" value=2 <?=$select3?>>2.0이상<INPUT TYPE="radio" NAME="gd_use" value=1 <?=$select2?>>2.0이하<INPUT TYPE="radio" NAME="gd_use" value=0 <?=$select1?>>사용않함</td>
				</tr>
				<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
				</table>
			</td>
			...
			<td>
				...
				<tr>
					<td>
						...
						<tr>
							<td class=han2>· 가로 출력개수 :</td><td><input type="text" class=textarea2 name=num size=3 value=<?=$num?>> 개  (리스트메인에서 보여질 작은이미지개수)</td>
						</tr>
						<tr><td height=7 colspan=2></td></tr>
							<td class=han2>· 가로 크기 :</td><td><input type="text" class=textarea2 name=min_width_size size=5 value=<?=$min_width_size?>> 픽셀  (리스트메인에서 보여질 작은이미지 가로크기)</td>
						</tr>
						<tr><td height=7 colspan=2></td></tr>
					...
					<td valign=top>
						...
						<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
						<tr><td height=7 colspan=2></td></tr>
						<tr><td class=han2>· 조회그래프(쵀대조회수값)&nbsp;: <input type="text" class=textarea2 name=max_hit size=4 value=<?=$max_hit?>> 개</td>
						</tr>
