...
.com {font-family:tahoma;font-size:8pt;color:ffffff}
.com2 {font-family:tahoma;font-size:7pt;color:666666}
.com3 {font-family:tahoma;font-size:7pt;color:ff9966}
.han {font-family:tahoma;font-size:8pt;color:00ff00}
.han2 {font-family:tahoma;font-size:8pt;color:aaaaaa}
.han3 {font-family:tahoma;font-size:8pt;color:ff6600}
.han4 {font-family:tahoma;font-size:8pt;color:ffcccc}
...
<td>
	...
	<td>
		...
		<td class=com3 align=left><B>F2plus gallery ver2.0</B></td><td class=com2 align=right>configuration | for zeroboard</td>
		</tr>
	...
	<tr><td height=10></td></tr><tr><td>
		...
		<tr valign=bottom><td align=left class=com>▒ <B>공통사항</B></td>
		<td><a href=<?=urlencode('매뉴얼.txt')?> target=_blank><font class=han3><U>매뉴얼/미리보기</U></font></a></td>
		</tr></table>
		</tr></td>
		...
		<tr valign=top><td>
			...
			<tr valign=top>
			<td class=han2>1. 썸네일 사용 
			</td>
			<?if($Thumbnail_use=="off") $select=""; else $select="checked";?>
			<td><input type="checkbox" value=1 name=thumb <?=$select?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>2. Exif 정보 
			</td>
			<?if($Exif_use=="off") $select=""; else $select="checked";?>
			<td><input type="checkbox"  value=1 name=exif <?=$select?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>3. 이모티콘 사용 
			</td>
			<?if($emoticon_use=="off") $select=""; else $select="checked";?>
			<td><input type="checkbox"  value=1 name=emouse <?=$select?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>4. 메인썸네일 사용 
			</td>
			<?if($Thumbnail_view=="off") $select=""; else $select="checked";?>
			<td><input type="checkbox" value=1 name=viewthumb <?=$select?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>5. 최대 썸네일 가로크기 
			</td>
			<td><input type="text" class=textarea name=maxwidth size=5 value=<?=$max_width_size?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			</table>
			</td>
			...
			<tr><td>		
			<tr valign=top>
			<td class=han2>1. No(글순번) 삭제 
			</td>
			<?if($hide_no=="off") $select=""; else $select="checked";?>
			<td><input type="checkbox" value=1 name=no_use <?=$select?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>2. 이름 삭제 
			</td>
			<?if($hide_name=="off") $select=""; else $select="checked";?>
			<td><input type="checkbox" value=1 name=name_use <?=$select?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>3. Date 삭제 
			</td>
			<?if($hide_date=="off") $select=""; else $select="checked";?>
			<td><input type="checkbox" value=1 name=date_use <?=$select?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>4. 추천기능 삭제 
			</td>
			<?if($hide_vote=="off") $select=""; else $select="checked";?>
			<td><input type="checkbox" value=1 name=vote_use <?=$select?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>5. 조회수 삭제 
			</td>
			<?if($hide_hit=="off") $select=""; else $select="checked";?>
			<td><input type="checkbox" value=1 name=hit_use <?=$select?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			</table>
			</td>
			...
			<tr valign=top>
			<td class=han2>1. 제로보드 경로 
			</td>
			<td class=han2><input type="text" class=textarea name=zburl size=38 value=<?=$zb_url?>>	끝에 "/" 넣지마세요</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>2. 절대 경로 
			</td>
			<td><input type="text" class=textarea name=zbpath size=38 value=<?=$zb_path?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>3. 이모티콘 경로 
			</td>
			<td class=han2><input type="text" class=textarea name=emoticon_url size=38 value=<?=$emoticon_url?>>	끝에 "/" 넣지마세요</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>4. 게시판 이름 
			</td>
			<td><input type="text" class=textarea name=board_id size=25 value=<?=$id?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr><td height=6 colspan=2></td></tr>
			<?$select1=""; $select2=""; $select3="";
				if($gd_use==0) $select1="checked"; elseif($gd_use==1) $select2="checked"; else $select3="checked";?>
			<tr><td colspan=2 align=left class=han3>◎ GD Version 선택&nbsp;&nbsp;<INPUT TYPE="radio" NAME="gd_use" value=2 <?=$select3?>>2.0이상<INPUT TYPE="radio" NAME="gd_use" value=1 <?=$select2?>>2.0이하<INPUT TYPE="radio" NAME="gd_use" value=0 <?=$select1?>>사용않함</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			</table>
			<tr valign=top>
			<?$select1=""; $select2=""; 
			  if($category_use==1) $select1="checked"; else $select2="checked";?>
		...
		<INPUT TYPE="radio" NAME=category_use value=1 <?=$select1?>>사용&nbsp;&nbsp;<INPUT TYPE="radio" NAME=category_use value=2 <?=$select2?>>미사용</td>
			<?$select1=""; $select2=""; 
			if($img_show=="on") $select1="checked"; else $select2="checked";?>
	...
	<tr><td height=1></td></tr><tr><td>

		<table border="0" cellpadding="5" cellspacing="0" width="98%" align=center>
		<tr valign=bottom><td align=left class=com>▒ <B>형태선택</B></td></tr></table>
		
		<table border="0" cellpadding="5" cellspacing="0" width="98%" align=center class=border>
		<col width=260></col><col width=10></col><col width=></col>
		<tr valign=top><td>
			<table border="0" cellpadding="1" cellspacing="0" width="95%" align=center>
			<col width=80></col><col align=left width=></col>
			<tr valign=top>
			<td class=han2>1. A_type :
			</td>
			<td class=han2>게시판형</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>2. A2_type :
			</td>
			<td class=han2>게시판형(Graphical)</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>3. B_type :
			</td>
			<td class=han2>전시회형</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>4. C_type :
			</td>
			<td class=han2>세로 오버형</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>5. D_type :
			</td>
			<td class=han2>가로 클릭형</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>6. Movie_type :
			</td>
			<td class=han2>영화 갤러리</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			</table>
			</td>
			...
			<?if($type=="A_type") $select_A="checked"; elseif($type=="A2_type") $select_A2="checked"; elseif($type=="B_type") $select_B="checked"; elseif($type=="C_type") $select_C="checked"; elseif($type=="D_type") $select_D="checked"; elseif($type=="Movie_type") $select_M="checked";?>
		...
		<tr><td>
			...
			<tr valign=top>
			<td align=left class=com colspan=2>▒ <B>특별사항1</B> <font class=han4>(<B>A-type,A2-type 제외</B>)</font></td></tr>
			<tr><td height=7 colspan=2></td></tr>
			<tr>
			<td class=han2>· 가로 출력개수 :</td><td><input type="text" class=textarea2 name=num size=3 value=<?=$num?>> 개  (리스트메인에서 보여질 작은이미지개수)
			</td>
			</tr>
			<tr><td height=7 colspan=2></td></tr>
			<td class=han2>· 가로 크기 :</td><td><input type="text" class=textarea2 name=min_width_size size=5 value=<?=$min_width_size?>> 픽셀  (리스트메인에서 보여질 작은이미지 가로크기)
			</td>
			</tr>
			<tr><td height=7 colspan=2></td></tr>
			...
			<tr><td height=7 colspan=2></td></tr>
			<tr>
			<td align=left colspan=2 class=com>▒ <B>기타사항</B></td></tr>
			<tr><td height=7 colspan=2></td></tr>
			<tr>
			<td colspan=2><font class=han4> 생성된 썸네일 이미지를 삭제합니다.</font>&nbsp;&nbsp;<a href=del_thumb.php?id=<?=$id?>&zb_path=<?=$zb_path?> target=_blank>"<B><U>삭제하기</U></B>"&nbsp;&nbsp;</a><font class=han3>(※주의 : 클릭하시면 바로 삭제됩니다.)</font></td>
			</tr>
			</table>
			</td>
			<td rowspan=2>
			...
			<tr valign=top>
			<td align=left class=com colspan=2>▒ <B>특별사항2</B> <font class=han4>(<B>A-type,A2-type 일경우</B>)</font></td></tr>
			<tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr><td height=7 colspan=2></td></tr>
			<td class=han2>· 조회그래프(쵀대조회수값)&nbsp;: <input type="text" class=textarea2 name=max_hit size=4 value=<?=$max_hit?>> 개</td>
			</tr>
			<tr>
			<td class=han2>리스트메인에서 우측에 조회그래프의 최대조회값을 이야기합니다.
			</td>
			</tr>
			</table><BR><BR>
			<table border="0" cellpadding="0" cellspacing="0" width="100%" align=center>
			<tr valign=middle><td colspan=3 align=right>
...
<table border=0 width=100% cellspacing=0 cellpadding=10px>
	<tr height=10 align=right><td class=com2>Copyright 2003-2004 by <a href=http://www.f2plus.com>www.f2plus.com</a></td></tr>
</table></td></tr>
</table>
</form>
