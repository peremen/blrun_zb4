...
<tr>
  ...
  <td align=left><input type=text name=user_id size=20 maxlength=20 class=input style=width:100%></td>
</tr>
<tr>
  <td align=right height=26><font class=list_eng>Password</font></td>
  <td align=left><input type=password name=password size=20 maxlength=20 class=input style=width:100%></td>
</tr>
</table>
<br>
