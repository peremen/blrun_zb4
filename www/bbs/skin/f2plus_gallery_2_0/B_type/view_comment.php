...
<tr valign=bottom>
	...
	<td background=<?=$dir?>/cc_foot_bg2.gif align=left><?if($hide_name=="off"){?><?=$c_face_image?> <font class=thm7pt><?=$comment_name?>&nbsp;</font><?}?>
	</td>
	<td background=<?=$dir?>/cc_foot_bg2.gif align=right><font class=com5><?=$show_comment_ip?></font><BR><img src=<?=$dir?>/t.gif height=7 align=absmiddle><BR><?if($hide_date){?><font class=com3><img src=<?=$dir?>/c_date.gif border=0 align=absmiddle> <?=date("Y-m-d",$c_data[reg_date])?>&nbsp;<?=date("H:i:s",$c_data[reg_date])?>&nbsp;</font><?}?> <?=$a_edit2?><img src=<?=$dir?>/edit2.gif border=0 valign=absmiddle></a> <?=$a_edit?><img src=<?=$dir?>/edit.gif border=0 valign=absmiddle></a> <font style=font-family:tahoma;color:f1f1f1;font-size:7pt><?=$a_del?><img src=<?=$dir?>/c_del.gif border=0 align=absmiddle></font></a></td>
