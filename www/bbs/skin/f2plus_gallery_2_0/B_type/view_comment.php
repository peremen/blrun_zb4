...
<tr valign=bottom>
	...
	<td background=<?=$dir?>/cc_foot_bg2.gif valign=top><?if($hide_name=="off"){?><BR><img src=images/t.gif height=4><BR><?=$c_face_image?> <font class=thm7pt><?=$comment_name?>&nbsp;</font><?}?><?=$a_comm_r?><img src=<?=$dir?>/reply.gif border=0 valign=absmiddle></a></td>
