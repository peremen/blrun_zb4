...
<tr align=center height=55 style=padding-bottom:3px>
	...
	<td class=list_main3>
		...
		<tr valign=bottom>
			<td align=left style=padding-top:10px><div style="overflow:hidden"><nobr><font style=color:8D8D8D>&nbsp;&nbsp;&nbsp;
			<? if(!$data[is_secret]) echo substr(stripslashes($_name1[0]),0,400); else echo "비밀글입니다"; ?>
			</font></nobr></div></td>
			<?if($hide_name!="on"){?><? if($browser=="1"){ ?>
			<td align=center class=com8 style=padding-bottom:2px><div style="overflow:hidden"><img src=<?=$dir?>/point.gif align=absmiddle>&nbsp;<?=($m_data[point1]*10+$m_data[point2])?></div></td><? } ?><?}?>
