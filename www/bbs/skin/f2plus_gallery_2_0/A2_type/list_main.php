	...
	<tr align=center height=55 style=padding-bottom:3px>
		...
		<td class=list_main3>
			...
			<tr valign=bottom>
				...
				<?if($hide_name!="on"){?><? if($browser=="1"){ ?><td align=center class=com8 style=padding-bottom:2px><div style="overflow:hidden"><img src=<?=$dir?>/point.gif align=absmiddle>&nbsp;<?=($m_data[point1]*10+$m_data[point2])?></div></td><? } ?><?}?>
