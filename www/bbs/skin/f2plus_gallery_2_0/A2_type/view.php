...
<?if($prev_thumb){?><td align=right><?=$a_prev?><span onMouseMove="msgposit(100,-15,event)";  onMouseOver="msgset('<img src=<?=$prev_thumb?> border=0 width=200>')"; onMouseOut="msghide();" class=shadow style='cursor:hand'><img src=<?=$dir?>/prev_img.gif border=0 align=absmiddle></span></a></td><?}?>
<?if($next_thumb){?><td align=right><?=$a_next?><span onMouseMove="msgposit(100,-15,event)";  onMouseOver="msgset('<img src=<?=$next_thumb?> border=0 width=200>')"; onMouseOut="msghide();" class=shadow style='cursor:hand'><img src=<?=$dir?>/next_img.gif border=0 align=absmiddle></span></a></td><?}?>
</tr>
	...
	<td height=100 valign=top>
		...
		<tr>
			<td align=center class=com2>
				<?=$view_img2?></a><br>
				<?=$hide_download2_start?><font class=com2>- <b>Download #2</b> : <?=$a_file_link2?><?=$file_name2?> <font class=com6>(<?=$file_size2?>,<?=$img_info2[0]?>x<?=$img_info2[1]?>)</font></a>, Download : <?=$file_download2?>&nbsp;<?=$print_img2?><img src=<?=$dir?>/show_img.gif border=0 align=absmiddle></a><br>
				<?=$hide_download2_end?>
		</td></tr>
		</table>
