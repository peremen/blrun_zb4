	...
	<td height=100 valign=top>
		...
		<tr>
			<td align=center class=com2>
				<?=$view_img2?><br>
				<?=$hide_download2_start?><font class=com2>- <b>Download #2</b> : <?=$a_file_link2?><?=$file_name2?> <font class=com6>(<?=$file_size2?>,<?=$img_info2[0]?>x<?=$img_info2[1]?>)</font></a>, Download : <?=$file_download2?>&nbsp;<?=$print_img2?><img src=<?=$dir?>/show_img.gif border=0 align=absmiddle></a><br><?=$hide_download2_end?>
