...
<tr>
	...
	<td class=com9><font color=F2955C class=com><?=++$count?>.</font>&nbsp;::: 
		...
		<br><?if($c_data[is_secret]) echo "<img src=".$dir."/post_security.gif border=0>";?><?if(preg_match("#\|\|\|[0-9]{1,}\|[0-9]{1,10}$#",$o_data[memo])) echo "<font color=orange>To $o_data[name]</font>";?><?=$c_memo?><? } ?></td>
