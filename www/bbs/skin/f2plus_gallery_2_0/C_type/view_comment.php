...
<tr>
	...
	<td><font color=F2955C class=com><?=++$count?>.</font>&nbsp;::: 
		...
		<br><font class=com2><?if($c_data[is_secret]) echo "<img src=".$dir."/post_security.gif border=0>";?><?if(preg_match("#\|\|\|[0-9]{1,}\|[0-9]{1,10}$#",$o_data[memo])) echo "<font color=blue>To $o_data[name]</font>";?><?=$c_memo?><? } ?></td>
...
<tr valign=bottom>
	...
	<td background=<?=$dir?>/cc_foot_bg2.gif align=left valign=top><?if($hide_name=="off"){?><BR><img src=images/t.gif height=4><BR><?=$c_face_image?> <font class=thm7pt><?=$comment_name?>&nbsp;</font><?}?><?=$a_comm_r?><img src=<?=$dir?>/reply.gif border=0 valign=absmiddle></a></td>
	<td background=<?=$dir?>/cc_foot_bg2.gif align=right><font class=com5><?=$show_comment_ip?></font><BR><img src=<?=$dir?>/t.gif height=7 align=absmiddle><BR><?if($hide_date=="off"){?><font class=com3><img src=<?=$dir?>/c_date.gif border=0 align=absmiddle> <?=date("Y-m-d",$c_data[reg_date])?>&nbsp;<?=date("H:i:s",$c_data[reg_date])?>&nbsp;</font><?}?> <?=$a_edit2?><img src=<?=$dir?>/edit2.gif border=0 valign=absmiddle></a> <?=$a_edit?><img src=<?=$dir?>/edit.gif border=0 valign=absmiddle></a><font style=font-family:tahoma;color:f1f1f1;font-size:7pt><?=$a_del?><img id=deleteButton_<?=$c_data[no]?> src=<?=$dir?>/c_del.gif border=0 align=top></a></font></td>
