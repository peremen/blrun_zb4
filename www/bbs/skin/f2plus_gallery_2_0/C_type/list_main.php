...
else
{
	if(preg_match(" <img src='images/ico_file.gif' border=0>",$subject)) {
		...
		$link=str_replace("$temp</a>","<img src=$dir/detail.gif border=0 align=absmiddle alt=\"제목 : $temp\"> <img src='images/ico_file.gif' border=0></a>",$subject);
	}
	else {
		$link=str_replace("$temp</a>","<img src=$dir/detail.gif border=0 align=absmiddle alt=\"제목 : $temp\"></a>",$subject);
	}
}
...
if($Exif_use=="on") {
	...
	if($hide_name=="off") $str="작성자 : ".htmlspecialchars($data[name],ENT_COMPAT,'ISO-8859-1',true)."\n".$str;
}
else $str="";
