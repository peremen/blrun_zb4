...
if($mode=="modify"&&$c_no) {
	...
	if($type=="Movie_type") mysqli_query($connect,"update $t_comment"."_$id"."_movie set point1='$_point1',point2='$_point2' where parent='$no' and reg_date='$c_date'") or error1(mysqli_error($connect));
	...
	if($type=="Movie_type") mysqli_query($connect,"insert into $t_comment"."_$id"."_movie (parent,reg_date,point1,point2) values ('$no','$reg_date','$_point1','$_point2')") or error1(mysqli_error($connect));
	// 회원일 경우 해당 해원의 점수 주기
