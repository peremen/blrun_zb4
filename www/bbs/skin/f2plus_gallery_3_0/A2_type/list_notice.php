...
?>
	...
	<tr align=center height=50 style=padding-bottom:3px class=list<?=$coloring%2?>>
		...
		<td class=list_notice3>
			...
			<tr>
				<td align=left style=padding-bottom:5px nowrap><div style="overflow:hidden"><?=$hide_cart_start?><input type=checkbox name=cart value="<?=$data[no]?>"><?=$hide_cart_end?>&nbsp;&nbsp;<img src=<?=$dir?>/images/notice_fr2.gif align=absmiddle border=0>&nbsp;<?=$insert?><B><?=$subject?></B><?=$comment_new?></div></td>
