...
<tr>
	...
	<?if($prev_thumb){?><td align=left width=70><?=$a_prev?><span onMouseMove="msgposit(100,-15,event)";  onMouseOver="msgset('<img src=<?=$prev_thumb?> border=0 width=200>')"; onMouseOut="msghide();" class=shadow style='cursor:hand'><img src=<?=$dir?>/images/prev_img.gif border=0 align=absmiddle></span></a></td><?}?>

	<?if($next_thumb){?><td align=left width=100><?=$a_next?><span onMouseMove="msgposit(100,-15,event)";  onMouseOver="msgset('<img src=<?=$next_thumb?> border=0 width=200>')"; onMouseOut="msghide();" class=shadow style='cursor:hand'><img src=<?=$dir?>/images/next_img.gif border=0 align=absmiddle></span></a></td><?}?>

</tr>
<tr><td height=1 colspan=3 background=<?=$dir?>/images/dot.gif></td>
</tr>
</table>
...
<tr class=list2>
	<td height=100 valign=top>
		...
		<tr>
			<td align=center>
				<?=$view_img1?><br>
				<?=$hide_download1_start?><font class=com2>- <b>Download #1</b> : <?=$a_file_link1?><?=$file_name1?> <font class=com6>(<?=$file_size1?>,<?=$img_info1[0]?>x<?=$img_info1[1]?>)</font></a>, Download : <?=$file_download1?></font>&nbsp;<?=$print_img1?><img src=<?=$dir?>/images/show_img.gif border=0 align=absmiddle></a><br><?=$hide_download1_end?>
		...
		<tr>
			<td align=center class=com2>
				<?=$view_img2?><br>
				<?=$hide_download2_start?><font class=com2>- <b>Download #2</b> : <?=$a_file_link2?><?=$file_name2?> <font class=com6>(<?=$file_size2?>,<?=$img_info2[0]?>x<?=$img_info2[1]?>)</font></a>, Download : <?=$file_download2?>&nbsp;<?=$print_img2?><img src=<?=$dir?>/images/show_img.gif border=0 align=absmiddle></a><br><?=$hide_download2_end?>
...
<tr><td background=<?=$dir?>/images/dot.gif border=0 height=1></td>
</tr>
</table>
