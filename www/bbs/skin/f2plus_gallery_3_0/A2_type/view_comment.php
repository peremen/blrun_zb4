...
<tr>
	...
	<td class=com9><font color=F2955C class=com><?=++$count?>.</font>&nbsp;::: 
		...
		<br><?if($c_data[is_secret]) echo "<img src=".$dir."/images/post_security.gif border=0>";?><?=$c_memo?><? } ?></td>
...
<tr valign=bottom>
	...
	<td background=<?=$dir?>/images/c_foot_bg2.gif valign=top><BR><img src=images/t.gif height=4><BR><?=$c_face_image?> <font class=thm7pt><?=$comment_name?>&nbsp;</font></td>
