...
<?}?>
		<td align=center valign=top>
			...
			<tr><td align=center><nobr><?=$hide_cart_start?><input type=checkbox name=cart value="<?=$data[no]?>"><?=$hide_cart_end?> <B><?=$str3?></B></nobr><?=$comment_new?></td></tr>
			<tr><td align=center><?if($hide_name=="off"){?>¡¤ <font class=com2><?=$name?></font>&nbsp;<?if($hide_date=="off"){?><font class=com3>(<?=date("m-d",$data[reg_date])?>) </font><?}?><?}?></td></tr>
			</table>
		</td>
<?if($counter%$num==0){?>
	</tr>
