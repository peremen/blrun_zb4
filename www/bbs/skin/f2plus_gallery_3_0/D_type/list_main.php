<?
	...
	else
	{
		...
		$link=str_replace("$data[subject]</a>","<img src=$dir/images/detail.gif border=0 align=absmiddle alt=\"제목 : $temp\"> <img src='images/ico_file.gif' border=0></a>",$subject);
		}
		else {
			$link=str_replace("$data[subject]</a>","<img src=$dir/images/detail.gif border=0 align=absmiddle alt=\"제목 : $temp\"></a>",$subject);
		}
	}
...
elseif($counter%$num==1) echo "</tr><tr valign=top>";?>
...
<td valign=top>
	...
	<tr><td><?=$full_img?><img src=<?=$dir?>/images/show_img.gif border=0></a></td><td align=left><?=$comment_new?></td>
	<td align=right><?=$link?><?=$hide_cart_start?><input type=checkbox name=cart value="<?=$data[no]?>"><?=$hide_cart_end?></td>
	</tr>
	</table>
</td><?if($loop_number==1) echo "</tr>"; $counter++;?>
