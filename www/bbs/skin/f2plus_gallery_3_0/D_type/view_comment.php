...
<tr valign=bottom>
	...
	<td background=<?=$dir?>/images/cc_foot_bg2.gif valign=top><?if($hide_name=="off"){?><BR><img src=images/t.gif height=4><BR><?=$c_face_image?> <font class=thm7pt><?=$comment_name?>&nbsp;</font><?}?></td>
