...
<script language="JavaScript">
<!--
function player(movie_source,movie_width,movie_height){ 
	movieWin = window.top.open("", "movieWin",
    "width="+movie_width+" ,height="+movie_height+",toolbar=no,menubar=no,statusbar=yse,resizeable=yes");
	movieWin.document.write("<script>");
	movieWin.document.write("location.href='"+movie_source+"'");
	movieWin.document.write("</script>");
} 
