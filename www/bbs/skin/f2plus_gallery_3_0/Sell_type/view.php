...
<tr class=list2 valign=top>
	<td valign=top>
		...
		<tr valign=top>
			...
			<table border=0 cellpadding=0 cellspacing=0><tr><td nowrap width=50><img src=<?=$dir?>/images/bolddot.gif border=0 align=absmiddle><B>&nbsp;제목</B> :&nbsp;</td><td nowrap width=100%><?=$subject?></td></tr></table>
		...
		<? if (!$view_img2){
			echo "</td></tr><tr><td><table width=100% border=0 cellspacing=0 cellpadding=0><tr><td height=4></td></tr><tr><td height=1 background=$dir/images/dot.gif></td></tr><tr><td height=4></td></tr></table><B>&nbsp;· 상품설명</B> :<BR><BR>".$_name1."</td></tr>";
		}else{?>
		</td></tr>
...
<table border=0 cellspacing=0 cellpadding=3 width=<?=$width?> align=center style=table-layout:fixed>
		<TR>
		<TD>&nbsp;<IMG height=30 src=<?=$dir?>/images/sell_foot_line.gif width=612></TD>
		</TR>
		<TR>
		<TD><DIV style="MARGIN: 5pt; LINE-HEIGHT: 17pt" align=justify>
		&nbsp;&nbsp;<IMG height=11 src=<?=$dir?>/images/sell_foot_bt.gif width=12>배송지역 : 전국<BR>
		&nbsp;&nbsp;<IMG height=11 src=<?=$dir?>/images/sell_foot_bt.gif width=12>미국 직배송 상품으로 받아보시는데 7일에서 최고 15일 이내 소요
		</DIV></TD>
		</TR>
		<tr><td height=1 background=<?=$dir?>/images/dot.gif></td></tr>
</table>
...
<a name="m_review_r"><img src=<?=$dir?>/images/sell_review.gif border=0></a><br></td></tr></table>
