...
<tr class=list2 valign=top>
	<td valign=top>
		...
		<? if (!$view_img2){
			echo "</td></tr><tr><td><table width=100% border=0 cellspacing=0 cellpadding=0><tr><td height=4></td></tr><tr><td height=1 background=$dir/images/dot.gif></td></tr><tr><td height=4></td></tr></table><B>&nbsp;· 상품설명</B> :<BR><BR>".$_name1."<BR><BR>";
