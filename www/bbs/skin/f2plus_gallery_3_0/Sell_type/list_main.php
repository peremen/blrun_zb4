...
<?=$hide_cart_start?><input type=checkbox name=cart value="<?=$data[no]?>"><?=$hide_cart_end?><?=$subject?>
<table width=100% border=0 cellspacing=0 cellpadding=0>
...
<tr><td><img src=<?=$dir?>/images/bolddot.gif border=0 align=absmiddle>&nbsp;<B>옵션</B>(종류)
<BR> &nbsp;<?=$_name5?></td></tr>
<tr><td height=1 background=<?=$dir?>/images/dot.gif></td></tr>
<tr><td height=4></td></tr>
</table>
...
<tr><td valign=top><div style="overflow:hidden"><B>· 상품설명</B> :&nbsp;<?=$tmp_memo?>..<?=$comment_new?></td></tr>
</table>
</td>
</tr>
</table></td>
