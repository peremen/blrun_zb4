...
<td>
	...
	<td>
		...
		<td class=com3 align=left><B>F2plus gallery v3.0</B></td><td class=com2 align=right>configuration | for zeroboard</td>
		</tr>
	...
	<tr><td height=10></td></tr><tr><td>
		...
		<tr valign=top><td>
			...
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>3. 웹에디터 사용 
			</td>
			<?if($emoticon_use!="on") $select=""; else $select="checked";?>
			...
			<td><input type="text" class=textarea name=maxwidth size=5 value=<?if($max_width_size=="") { echo "200";  } else { echo "$max_width_size"; } ?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			</table>
			</td>
			...
			<td class=han2><input type="text" class=textarea name=zburl size=38 value=<?if($zb_url=="") { echo "http://홈페이지주소/제로보드";  } else { echo "$zb_url"; } ?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			...
			<td class=han2><input type="text" class=textarea name=emoticon_url size=38 value=<?if($emoticon_url=="") { echo "/images/emoticon";  } else { echo "$emoticon_url"; } ?>></td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			...
			<tr><td colspan=2 align=left class=han3>◎ <a href=test.php target=_blank><font class=han3><U>GD Version</U></font></a> 선택&nbsp;&nbsp;<INPUT TYPE="radio" NAME="gd_use" value=2 <?=$select3?>>2.0이상<INPUT TYPE="radio" NAME="gd_use" value=1 <?=$select2?>>2.0이하<INPUT TYPE="radio" NAME="gd_use" value=0 <?=$select1?>>사용않함</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			</table>
			<tr valign=top>
			<?$select1=""; $select2=""; 
	...
	<tr><td height=1></td></tr><tr><td>
		...
		<tr valign=top><td>
			...
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr valign=top>
			<td class=han2>7. Sell_type :
			</td>
			<td class=han2>판매 갤러리</td></tr>
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			</table>
			</td>
		...
		<tr><td>
			...
			<tr>
			<td class=han2>· 가로 출력개수 :</td><td><input type="text" class=textarea2 name=num size=3 value=<?if($num=="") { echo "3";  } else { echo "$num"; } ?>> 개  (리스트메인에서 보여질 작은이미지)
			</td>
			</tr>
			<tr><td height=7 colspan=2></td></tr>
			<td class=han2>· 가로 크기 :</td><td><input type="text" class=textarea2 name=min_width_size size=5 value=<?if($min_width_size=="") { echo "100";  } else { echo "$min_width_size"; } ?>> 픽셀  (리스트메인에서 보여질 작은이미지)
			</td>
			</tr>
			<tr><td height=7 colspan=2></td></tr>
			...
			<tr><td height=1 bgcolor=333333 colspan=2></td></tr>
			<tr><td height=7 colspan=2></td></tr>
			<td class=han2>· 조회그래프(쵀대조회수값)&nbsp;: <input type="text" class=textarea2 name=max_hit size=4 value=<?if($max_hit=="") { echo "50";  } else { echo "$max_hit"; } ?>> 개</td>
			</tr>
			<tr>
