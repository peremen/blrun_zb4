...
if(!preg_match("/Zeroboard/i",$a_delete)) $a_delete=str_replace("delete.php?","delete.php?_zb_path=$config_dir&_zb_url=$zb_url/&",$a_delete)."";
?>
...
<tr>
 <td height=30>
	<?=$a_reply?><img src=<?=$dir?>/images/bt_reply.gif border=0></a>
	<?=$a_modify?><img src=<?=$dir?>/images/bt_modify.gif border=0></a>
	<?=$a_delete?><img src=<?=$dir?>/images/bt_del.gif border=0></a>
	<?=$a_vote?><img src=<?=$dir?>/images/bt_vote.gif border=0></a>
 </td>
 <td align=left>
	<table border=0>
		<tr><td>
 ...
 <td align=right>
	...
	<tr>
		...
		<td><?=$a_list?><img src=<?=$dir?>/images/bt_list.gif border=0></a></td>
		<td><?=$a_write?><img src=<?=$dir?>/images/bt_write.gif border=0></a></td>
	</tr>
	</table>
 </td>
</tr>
