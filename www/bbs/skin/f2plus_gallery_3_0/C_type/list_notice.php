...
<tr><td colspan=2>
	...
	<tr><td nowrap colspan=2 align=left style=padding:2,5,2,5><img src=<?=$dir?>/images/notice_fr.gif border=0 align=absmiddle>&nbsp;<?=$hide_cart_start?><input type=checkbox name=cart value="<?=$data[no]?>"><?=$hide_cart_end?>&nbsp;<?=$insert?><B><nobr><?=$subject?></nobr></B><?=$comment_new?></td></tr></table>
</td></tr>
</table>
