...
<tr align=center bgcolor=<?=$list_bg_color?> onMouseOver=this.style.backgroundColor='<?=$list_mouse_over_color?>' onMouseOut=this.style.backgroundColor=''>
	...
	<td align=left nowrap='nowrap'><div style="overflow:hidden"><img src=images/t.gif height=3><br><?=$insert?><?=$icon?><?=$subject?><?=$comment_new?><?=$new?></div></td>
	<td nowrap='nowrap'><div style="overflow:hidden"><img src=images/t.gif height=3><br><?=$face_image?><?=$name?></div></td>
	<td nowrap='nowrap' class=listnum><?=$reg_date?></td>
	<td nowrap='nowrap' class=listnum><?=$hit?></td>
	<td nowrap='nowrap' class=listnum><?=$vote?></td>
</tr>
