...
<tr>
  <td>
    ...
    <tr>
      ...
      <td style=font-family:Verdana;font-size:9pt;letter-spacing:-1px;><?=$hide_html_start?> <input type=checkbox name=use_html2<?=$use_html2?>>HTML사용<?=$hide_html_end?><?=$hide_secret_start?> <input type=checkbox name=is_secret <?=$secret?> value=1>비밀글<?=$hide_secret_end?></td>
      <td width=80>&nbsp;</td>
    </tr>
    <tr align=center> 
<!--코멘트 이름, 비번, 내용 시작-->
