...
<tr>
  <td bgcolor=<?=$list_header_back?>>
    ...
    <tr align=center valign=top>
      <td width=80><?=$c_name?><?=$hide_c_password_start?><br><img src=images/t.gif border=0 height=10><br><font style=font-family:Verdana;font-size:9pt;letter-spacing:-1px;><b>Password</b></font><br><img src=images/t.gif border=0 height=5><br><input type=password id=password name=password <?=size(8)?> maxlength=20 class=input onkeyup="ajaxLoad2()"><br>비번을 재입력하면 임시저장이 복원됨<?=$hide_c_password_end?></td>
      <td>
