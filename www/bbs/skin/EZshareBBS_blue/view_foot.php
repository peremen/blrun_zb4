...
<tr>
 <td height=30>
	...
	<? if($box_view) { echo $a_preview."<img src=$dir/btn_preview.gif border=0></a>".$a_imagebox."<img src=$dir/btn_imagebox.gif border=0></a>".$a_codebox."코드삽입</a>"; }?>
 </td>
 <td align=right>
    <?=$a_home?>[HOME]</a><?=$a_bitly?>[bitly]</a><?=$a_keyword?>[반전해제]</a>
    <?=$a_reply?><img src=<?=$dir?>/btn_reply.gif border=0></a>
    <?=$a_vote?><img src=<?=$dir?>/btn_vote.gif border=0></a>
