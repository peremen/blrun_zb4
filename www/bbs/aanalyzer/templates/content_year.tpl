  <table width="550" border="0" cellspacing="0" cellpadding="0">
   ...
   {section name=report_view loop=$analysis_info}
      <tr height="45">
        <td>&nbsp;</td>
        <td class="analysisTableItemRecordYear">{if $analysis_info[report_view].link_flag == 1}<a href="?id={$aa_page}&mode=4&y={$analysis_info[report_view].year}">{/if}{$analysis_info[report_view].year}{if $analysis_info[report_view].link_flag == 1}</a>{/if}</td>
