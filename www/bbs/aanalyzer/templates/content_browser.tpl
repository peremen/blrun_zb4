  <table width="550" border="0" cellspacing="0" cellpadding="0">
    <tr class="analysisTableTopItemTitles" height="30">
      ...
      <td background="images/content_top_bar2_center.gif" width="210">{$items_titles.subject}</td>
   ...
   {section name=report_view loop=$analysis_info}
      <tr height="45">
        <td>&nbsp;</td>
        <td class="analysisItem"><img src="images/icons/{$analysis_info[report_view].br_icon}.gif">&nbsp;{$analysis_info[report_view].browser_full_name}</td>
...
<div class="analysisHangulItem"><a href="{$analysis_view_file_name}?mode=2&id={$aa_page}&vo=fn" >{$items_titles.full_name_analysis}</a></div>
<div class="analysisHangulItem"><a href="{$analysis_view_file_name}?mode=2&id={$aa_page}&vo=ca" >{$items_titles.category_analysis}</a>
</div>
...
<div ></div>
    ...
    <tr >
    <td width="90">Total</td><td>: {$bottom_misc_counts.total}</td></tr>
    <td >Browser Counts</td><td>: {$bottom_misc_counts.items_counts}</td></tr>
