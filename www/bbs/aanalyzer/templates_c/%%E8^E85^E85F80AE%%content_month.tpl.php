<?php /* Smarty version 2.6.13, created on 2008-11-25 02:29:30
         compiled from content_month.tpl */ ?>
...
&mode=6&y=<?php echo $this->_tpl_vars['analysis_info'][$this->_sections['report_view']['index']]['year']; ?>
&m=<?php echo $this->_tpl_vars['analysis_info'][$this->_sections['report_view']['index']]['month']; ?>
"><?php endif;  echo $this->_tpl_vars['analysis_info'][$this->_sections['report_view']['index']]['month'];  if ($this->_tpl_vars['analysis_info'][$this->_sections['report_view']['index']]['link_flag'] == 1): ?></a><?php endif; ?></td>
...
%" height="14" /><?php endif;  if ($this->_tpl_vars['analysis_info'][$this->_sections['report_view']['index']]['graph_percentage'] != 100):  if ($this->_tpl_vars['analysis_info'][$this->_sections['report_view']['index']]['counts'] != 0): ?><img src="images/graph_red_right.gif" height="14"><?php endif;  endif; ?></td>
	<td width="9"><?php if ($this->_tpl_vars['analysis_info'][$this->_sections['report_view']['index']]['graph_percentage'] == 100): ?><img src="images/graph_red_right.gif" height="14"><?php endif; ?></td>
