<?php /* Smarty version 2.6.13, created on 2008-11-25 02:24:23
         compiled from create_target.tpl */ ?>
...
<table width="778" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr class="managerItemTitles">
    ...
    <td background="images/content_top_bar2_center.gif" width="757"><?php echo $this->_tpl_vars['create_page_messages']['title']; ?>
</td>
...
<table width="778" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr class="managerItemTitles">
    ...
    <td width="757"><?php echo $this->_tpl_vars['create_page_messages']['howto_1']; ?>
</td>
...
<?php echo $this->_tpl_vars['howto_starter']; ?>
<br>
<?php echo $this->_tpl_vars['howto_target']; ?>
<br>
<?php echo $this->_tpl_vars['howto_include']; ?>
<br>
<?php echo $this->_tpl_vars['howto_ender']; ?>
<br>
<?php echo $this->_tpl_vars['howto_javascript']; ?>
<br>
    </td>
    </tr>
  <tr class="managerCreateExample">
    <td style="BORDER-TOP: #d0d0d0 1px solid; BORDER-BOTTOM: #d0d0d0 1px solid">
<strong><?php echo $this->_tpl_vars['create_page_messages']['comment_title']; ?>
</strong><br/>
