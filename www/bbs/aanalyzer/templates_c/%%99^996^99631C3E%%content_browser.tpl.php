<?php /* Smarty version 2.6.13, created on 2008-11-25 02:32:04
         compiled from content_browser.tpl */ ?>
  <table width="550" border="0" cellspacing="0" cellpadding="0">
    <tr class="analysisTableTopItemTitles" height="30">
      ...
      <td background="images/content_top_bar2_center.gif" width="210"><?php echo $this->_tpl_vars['items_titles']['subject']; ?>
</td>
...
?>
      <tr height="45">
        <td>&nbsp;</td>
        <td class="analysisItem"><img src="images/icons/<?php echo $this->_tpl_vars['analysis_info'][$this->_sections['report_view']['index']]['br_icon']; ?>
.gif">&nbsp;<?php echo $this->_tpl_vars['analysis_info'][$this->_sections['report_view']['index']]['browser_full_name']; ?>
</td>
...
?mode=2&id=<?php echo $this->_tpl_vars['aa_page']; ?>
...
<div ></div>
    ...
    <tr >
    <td width="90">Total</td><td>: <?php echo $this->_tpl_vars['bottom_misc_counts']['total']; ?>
</td></tr>
    <td >Browser Counts</td><td>: <?php echo $this->_tpl_vars['bottom_misc_counts']['items_counts']; ?>
</td></tr>
