...
$name=$reply_data[name]=del_html($reply_data[name]);  // 이름
$email=$reply_data[email]=del_html($reply_data[email]);  // 메일
$subject=$reply_data[subject]=del_html($reply_data[subject]); // 제목
